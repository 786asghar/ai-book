...
:::tip Package Manager Choices
Choose one of the following package managers to install the Vercel CLI:
:::
...
For most frameworks (Next.js, React, Vue, Nuxt, Remix, SvelteKit, Astro, and others):
...
**TypeScript:**
```tsx {1, 7} title="pages/example-component.tsx"
...
**JavaScript:**
```jsx {1, 7} title="pages/example-component.jsx"
import { SpeedInsights } from "@vercel/speed-insights/react";
import { useRouter } from "next/router";
...
**TypeScript:**
```vue {2, 6} title="layouts/default.vue"
<script setup lang="ts">
import { SpeedInsights } from '@vercel/speed-insights/vue';
</script>
...
You can deploy your app to Vercel by running the following command from your terminal:
...
After a few days of visitors, you'll be able to start exploring your metrics. For more information on how to use Speed Insights, visit the [Vercel documentation](https://vercel.com/docs/speed-insights).
...
- [Explore pricing and limits](https://vercel.com/docs/speed-insights/limits-and-pricing)
